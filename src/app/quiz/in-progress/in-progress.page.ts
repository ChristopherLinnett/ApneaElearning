...
export class InProgressPage implements OnInit{
  ...
  questionList = {
    ...
    {
    questionText: 'If you are planning to go freediving, a minimum of how many people should be in your group?', 
    ...
    answers: [
      {text: 'The moment you start holding your breath in the water', num: 0},
    ...
    {
    questionText: 'Which of these is NOT one of the crucial rules of freediving?', 
    
    answers: [
      {text: 'Always dive with a buddy', num: 0},
      {text: 'Relax before you hold your breath', num: 1},
      {text: 'Be correctly weighted', num: 2},
      {text: 'Breathe quickly and heavily when preparing for a dive', num: 3}
    ], 
    correctAnswer: 3, 
    
    },
    {
    questionText: 'Which of these do NOT need to be completed before starting diving?', 
    ...
    4: [
    {
    questionText: 'At 20m below the surface, what volume are your lungs compared to at the surface?', 
    ...
    {
    questionText: 'Which of these are NOT one of the air spaces you need to consider when equalising? ', 
    ...
    {
    questionText: 'If having trouble equalising, which of these is not a helpful solution?', 
    ...
    answers: [
      ...
      {text: 'Stopping ascent to turn and achieve your depth goal', num: 3}
    ], 
    correctAnswer: 3, 
    
    },
    {
    questionText: 'Which of these is Not part of the turn after reaching your depth?', 
    ...
    answers: [
      ...
      {text: 'Doing a breast stroke pull to get under the surface', num: 2},
    ...
    6: [{
    questionText: 'Which of these is not an appropriate communication method when buddying during a static discipline?', 
    
    answers: [
      {text: 'Ask to raise a finger if they are OK', num: 0},
      {text: 'Ask the diver to raise multiple fingers to answer simple questions ', num: 1},
      {text: 'Squeeze the shoulder to have the diver respond with a raised finger', num: 2},
      {text: 'Give a visual signal for the diver to respond with a raised finger', num: 3}
    ], 
    correctAnswer: 3, 
    ...
    {
    questionText: 'Which of these is NOT a symptom/sign of an oncoming blackout? ', 
    ...
    {
    questionText: 'After rescuing a diver, unless they are responsive. How long should you continue to Blow-Tap-Talk', 
...
{
questionText: 'What is the order of durability for fins? Weakest to strongest', 
...
{
questionText: 'What is the order of efficiency for fins? Highest to lowest', 
...
{
questionText: 'Which of these involves swimming horizontal distance with fin(s)', 
...
{
questionText: 'Which of these involves swimming up and down a line, wearing fins with a weight belt', 
...
9: [
{
questionText: 'Congratulations You have completed the Chapters. These questions will not unlock another chapter. Which of these are important?', 
...
{
questionText: 'Thanks for completing this app. I hope you have benefited from it', 
...
correctAnswer: 0, 
  ...
  async createQuiz(chapter:number){
    ...
    var quiz=[]
    for (let premadeQuestion of this.questionList[`${this.currentModuleService.currentModuleIndex}`]){
      let question = new Question(premadeQuestion.questionText , [],premadeQuestion.correctAnswer)
