...
export class CourseService implements OnInit {
  ...
  /**
   * It returns the value of thisCourse.
  ...
  /**
   * It returns the value of the allCourses property
   * @returns The allCourses array.
   */
  getAllCourses() {
    return this.allCourses;
  }
  /**
   * It takes a course title, sets current course to the course that contains that title.
   * @param course - the course that is being set
   */
  setCourse(course) {
